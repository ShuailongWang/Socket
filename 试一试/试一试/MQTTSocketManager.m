...
#import "MQTTSocketManager.h"
#import "MQTTKit.h"

static  NSString * Khost = @"127.0.0.1";
static const uint16_t Kport = 6969;
static  NSString * KClientID = @"MQTT";


@interface MQTTSocketManager()
{
    MQTTClient *client;
...
@implementation MQTTSocketManager

+ (instancetype)share
{
    static dispatch_once_t onceToken;
    static MQTTSocketManager *instance = nil;
